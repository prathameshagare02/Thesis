...
class MetalSegmenter:
    ...
    def save_final_image(self):
        ...
        Background will be black where mask==0.
        """
        ...
        # Metal-only BGR image (black background)
    ...
    def show_morphological_controls(self):
        ...
        # Save only the final processed metal parts
        tk.Button(control_window, text="Save Processed Metal Parts", command=self.save_final_image,
    ...
    def fallback_segmentation(self, points, labels):
        ...
        if any(l == 1 for l in labels):
            ...
            if fg_points:
                xs = [p[0] for p in fg_points]; ys = [p[1] for p in fg_points]
    ...
    def show_results(self):
        ...
        self.update_results_display()
        # Optionally auto-save right after you view the results window:
