...
class MetalSegmenter:
    ...
    def visualize_tsne_clusters(self, embeddings, centers, n_clusters=2):
        ...
        # Plot: t-SNE 2D + patch centers on image
        fig, axes = plt.subplots(1, 2, figsize=(14, 6))
        fig.suptitle("Patch Embedding Structure (CLIP + t-SNE)",
        ...
        ax0.set_title("t-SNE (2D) of Patch Embeddings\nColor = rust / metal clusters")
        ...
        ax1 = axes[1]
        ax1.imshow(img_rgb)
        ax1.set_title("Patch Locations Colored by Cluster (rust vs metal)")
        ax1.axis("off")
        ...
        print("t-SNE (2D) + clustering visualization completed.")
        print("Interpretation ideas:")
        print("  - CLIP decides which cluster is 'rust' vs 'metal' based on text similarity.")
        print("  - The 2D plot shows the structure of patch embeddings; clusters should align with rust vs metal appearance.")
